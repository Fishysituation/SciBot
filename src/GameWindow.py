        ...
        if running:
            ...
            if buttons_on_the_left:
                ...
                go_button = Button('Go',
                                   ...
                                   GameWindow.WHITE,
                                   "",
                                   (self.width + 140, float(self.height)/2 - 60 - 90),
                                   (120, 120))
                ...
                reset_button = Button('Reset',
                                      ...
                                      GameWindow.WHITE,
                                      "",
                                      (self.width + 10, float(self.height)/2 + 70 - 90),
                                      (120, 120))
